...
excerpt: This week, a lot of work has been done with the prototype - the foam mold of the drone is almost entirely complete and layering process should begin next week.
---

import image1feb20 from "./feb-20-image-1.png";
import image2feb20 from "./feb-20-image-2.png";
import image3feb20 from "./feb-20-image-3.png";
...
<div className="screenshots-update-container">
  <img src={image1feb20} className="update" />
  <img src={image2feb20} className="update" />
  <img src={image3feb20} className="update" />
</div>
